...
int main(int argc, char** argv) {
  ...
  *p5=80000;
  ...
  p1=BuddyAllocator_malloc(&alloc, 58);
  p2=BuddyAllocator_malloc(&alloc, 68);
  BuddyAllocator_free(&alloc, p3);
  BuddyAllocator_free(&alloc, p1);
  BuddyAllocator_free(&alloc, p2);
  //BuddyAllocator_free(&alloc, p2); //double free
  //BuddyAllocator_free(&alloc, p3+5); //free non allineata
} 
/*
  int bit_num=0;
